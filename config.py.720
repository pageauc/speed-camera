...
#               Ver 3.80  speed-cam.py Variable Configuration Settings
...
# Camera Settings
# ===============
CAMERA_WIDTH = 1280    # Image stream width for opencv motion scanning default=320
CAMERA_HEIGHT = 720    # Image stream height for opencv motion scanning  default=240
CAMERA_FRAMERATE = 25  # framerate for video stream default=35 90 max for V1 cam. V2 can be higher
...
image_font_size = 20          # font text height in px for text on images default=10
...
# =======================================
y_upper = 240          # Exclude event if y less that this value default=100
y_lower = 480          # Exclude event if y greater than this value default=200
x_left  = 480          # Exclude event if x less than this px position Default=25
x_right = 800          # Exclude event if x greater than this px position Default=295
